...
if (!\class_exists('FcfVendor\\WPDesk_Tracker_Factory_Prefixed')) {
    ...
    class WPDesk_Tracker_Factory_Prefixed
    {
        ...
        {
            $sender = \apply_filters('wpdesk/tracker/sender/' . $basename, new \FcfVendor\WPDesk_Tracker_Sender_Wordpress_To_WPDesk());
            $sender = new \FcfVendor\WPDesk_Tracker_Sender_Logged($sender instanceof \WPDesk_Tracker_Sender ? $sender : new \FcfVendor\WPDesk_Tracker_Sender_Wordpress_To_WPDesk());
