...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FcfVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
     ...
     */
    public static function getInstance($name) : \FcfVendor\Monolog\Logger
    {
