...
class NewRelicHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($level = \FcfVendor\Monolog\Logger::ERROR, bool $bubble = \true, ?string $appName = null, bool $explodeArrays = \false, ?string $transactionName = null)
    {
