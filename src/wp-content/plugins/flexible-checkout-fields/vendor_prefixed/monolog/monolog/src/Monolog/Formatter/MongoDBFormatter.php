...
class MongoDBFormatter implements \FcfVendor\Monolog\Formatter\FormatterInterface
{
    ...
    {
        $formattedException = ['class' => \FcfVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
