...
class PushoverHandler extends \FcfVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \FcfVendor\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \FcfVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FcfVendor\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \FcfVendor\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \FcfVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
     * @param int|string $value
    ...
    {
        $this->emergencyLevel = \FcfVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
