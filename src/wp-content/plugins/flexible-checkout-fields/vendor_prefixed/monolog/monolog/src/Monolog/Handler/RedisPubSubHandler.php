 ...
 */
class RedisPubSubHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FcfVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
