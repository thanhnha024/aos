 ...
 */
class PsrHandler extends \FcfVendor\Monolog\Handler\AbstractHandler implements \FcfVendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \FcfVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
