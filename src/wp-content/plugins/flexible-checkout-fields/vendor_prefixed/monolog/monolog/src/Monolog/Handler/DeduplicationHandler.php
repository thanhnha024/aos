...
class DeduplicationHandler extends \FcfVendor\Monolog\Handler\BufferHandler
{
     ...
     */
    public function __construct(\FcfVendor\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \FcfVendor\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
