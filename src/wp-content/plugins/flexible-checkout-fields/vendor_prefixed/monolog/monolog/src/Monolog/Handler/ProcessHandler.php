 ...
 */
class ProcessHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct(string $command, $level = \FcfVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?string $cwd = null)
    {
        if ($command === '') {
