...
class PHPConsoleHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(array $options = [], ?\FcfVendor\PhpConsole\Connector $connector = null, $level = \FcfVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    private function initConnector(?\FcfVendor\PhpConsole\Connector $connector = null) : \FcfVendor\PhpConsole\Connector
    {
        if (!$connector) {
    ...
    public function getConnector() : \FcfVendor\PhpConsole\Connector
    {
